...
const Register = (progs) => {
    const handleClick = () => {
        progs.handleClickChild(false);
    }

    const handleClickSigin = () => {
        progs.handleClickChild2(true);
    }
    ...
    const [validEmail, setValidEnail] = useState(false);
    const [emailFocus, emaFocus] = useState(false);
    ...
    return <Fragment>
        <div className="bg-form">
            ...
            <div className="login-form">
                ...
                <div className="main">
                    <div className="switch is-txr" id="switch-cnt">
                       ...
                       <div className="switch__container" id="switch-c1">
                           ...
                           <button className="switch__button button switch-btn" onClick={ handleClickSigin }>SIGN IN</button>
                       </div>         
                    </div>
                    ...
                    <div className="container a-container is-txl" id="a-container">
                        ...
                        <p ref={errRef} className={errMsg ? "errmsg" : "offscreen"} aria-live="assertive">{errMsg}</p>
                            ...
                            <button className="form__button button submit"><Link to={"/boards"}>Sign Up</Link></button>
                            </form>
                    </div>
                ...
                <div className="close" >
                    <img className="close-icon" src="https://www.freeiconspng.com/uploads/close-icon-39.png" alt="a" onClick={ handleClick } />
                </div>
            </div>
        </div>
    </Fragment>
