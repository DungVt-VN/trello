            ...
            <div className="login-form">
                ...
                <div className="main">
                        ...
                        <div className="container b-container" id="b-container">
                            ...
                            <button className="form__button button submit"><Link to={"/boards"}>SIGN IN</Link></button>
                            </form>
                        </div>
                        ...
                        <div className="switch" id="switch-cnt">
                            ...
                            <div className="switch__container" id="switch-c2">
                                ...
                                <button className="switch__button button switch-btn" onClick={ handleClickSigup }>SIGN UP</button>
                            </div>
